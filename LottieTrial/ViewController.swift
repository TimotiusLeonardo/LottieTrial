...
class ViewController: UIViewController {
    ...
    let urlInString: [String] = [
        "https://assets9.lottiefiles.com/packages/lf20_LBnGq7OY4M.json",
        "https://assets9.lottiefiles.com/packages/lf20_jfXcHs2ED8.json",
        "https://assets9.lottiefiles.com/packages/lf20_aw5nxeBcYI.json",
        "https://assets9.lottiefiles.com/packages/lf20_1xU9Bzegk7.json"
    ]
    ...
    func playRandomAnimation() {
        let url = URL(string: urlInString.randomElement()!)
